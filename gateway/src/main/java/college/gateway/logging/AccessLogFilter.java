        ...
        return new ServerHttpResponseDecorator(response) {
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    // 设置其它字段
                    gatewayLog.setUserId(MapUtil.getLong(exchange.getAttributes(), LOGIN_USER_ID_ATTR));
                    gatewayLog.setUserType(MapUtil.getInt(exchange.getAttributes(), LOGIN_USER_TYPE_ATTR));
